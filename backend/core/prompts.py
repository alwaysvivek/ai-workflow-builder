"""
Prompt Registry (Pipeline Stage: Configuration)
=============================================

This module stores the source-of-truth prompt templates for all workflow actions.
It decouples the prompt content from the execution logic, allowing for easier iteration.

Responsibilities:
-   **Definitions**: Enum for ActionTypes.
-   **Templates**: Python string-format templates for LLM instructions.
"""
